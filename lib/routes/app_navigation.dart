...
class AppNavigator {
  ...
  /// 跳转至分类子级（三级分类网格页，如抖音"竞技游戏"下的具体游戏）
  static void toAreaSubAreas({required Site site, required LiveArea category}) {
    Get.toNamed(RoutePath.kAreaSubAreas, arguments: [site, category]);
  }
