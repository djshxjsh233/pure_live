...
class UniAttribute extends TarsStruct {
  ...
  void put<T>(String name, T t) {
    ...
    out.setServerEncoding(encodeName);
    out.write(t, 0);
    Uint8List sBuffer = out.toUint8List();
  ...
  void checkObjectType(List<String> listType, dynamic o) {
    ...
    if (o is List) {
      ...
      if (o.isNotEmpty) {
        ...
        listType.add(BasicClassTypeUtil.dart2UniType(key.runtimeType.toString(), key));
      ...
      listType.add(BasicClassTypeUtil.dart2UniType(o.runtimeType.toString(), o));
    }
  }
  ...
  void decode(Uint8List buffer, {int index = 0}) {
    ...
    try {
      ...
      oldData = inputStream.readMapMap<String, String, Uint8List>(oldData, 0, false);
    } catch (ex) {
